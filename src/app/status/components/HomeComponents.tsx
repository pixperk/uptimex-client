import { IMonitorDocument, IMonitorState, IPagination } from "@/interfaces/monitor.interface";
...
export const renderCreateButton = (
  ...
  return (
    <div className="h-screen flex items-center justify-center bg-white">
      <div className="text-center scale-90 -mt-10">
        <div className="mb-6">
          <Image
        ...
        <h1 className="text-3xl font-bold text-gray-800 mb-4">No Uptime Tests Yet</h1>
        <p className="text-lg text-gray-600 mb-6">Start monitoring your servers by creating your first uptime test.</p>
        <button
