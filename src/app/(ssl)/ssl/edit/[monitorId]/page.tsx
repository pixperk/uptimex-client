...
const EditSSLMonitor: FC<EditMonitorProps> = ({ params }): ReactElement => {
  const monitorId = use(params).monitorId;
  const {
    loading,
    monitorInfo,
    notifications,
          ...
          <div className="p-6 m-auto mt-4 border w-[80%] bg-lightGray">
            ...
            <MonitorItem
              ...
              className={clsx(
                ...
                {
                  "border-red-400": validationErrors?.name,
                }
              )}
            ...
            <MonitorItem
              ...
              className={clsx(
                "bg-white border border-black text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5",
                {
                  "border-red-400": validationErrors?.url,
                }
              )}
            ...
            <div className="mt-5">
              ...
              <select
                ...
                className={clsx(
                  ...
                  {
                    "border-red-400": validationErrors?.notificationId,
                  }
                )}
                value={
              ...
              {validationErrors?.notificationId && (
            ...
            <MonitorItem
              ...
              labelEnd="Number of errors that must occur before sending a notification. Add 0 if no error notification is required."
              className={clsx(
                "bg-white border border-black text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5",
                {
                  "border-red-400": validationErrors?.alertThreshold,
                }
              )}
