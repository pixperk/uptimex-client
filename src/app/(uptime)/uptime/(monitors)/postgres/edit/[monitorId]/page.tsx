...
import { usePostgresEdit } from "@/app/(uptime)/hooks/usePostgresMonitor";
import PageLoader from "@/components/PageLoader";
import { EditMonitorProps } from "@/interfaces/monitor.interface";
import { ChangeEvent, FC, ReactElement, use } from "react";

const EditPostgresMonitor: FC<EditMonitorProps> = ({ params }): ReactElement => {
...
export default EditPostgresMonitor;
