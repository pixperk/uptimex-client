...
const View: FC<ViewProp> = ({ params }): ReactElement => {
  ...
  return (
    <>
      {monitor ? (
        <div className="m-auto mt-2 px-6 relative min-h-screen xl:container">
           <button
              onClick={() => router.push("/status")}
              className="flex items-center text-[#1e8dee] hover:text-[#1a7ac7] transition-colors duration-200"
            >
