          ...
          <div className={clsx(
            ...
            <div className="text-[#74767e] lg:pr-4 w-full lg:w-auto">
              <ul className="flex flex-col lg:flex-row gap-4 text-base font-medium w-full lg:w-auto">
                <li className={clsx("z-50 flex cursor-pointer items-center relative h-9 justify-center rounded-full bg-green-500 text-white font-bold sm:px-6 hover:bg-green-400",{
                  'ml-auto' : !menuOpen
                })}>
                  <Link href="/status" className="z-50">
                    Monitor Dashboard
                  </Link>
                </li>
                <li className={clsx("z-50 flex cursor-pointer items-center relative h-9 justify-center rounded-full bg-green-500 text-white font-bold sm:px-6 hover:bg-green-400",{
