...
import { FaAlignJustify, FaPowerOff, FaTimes, FaUserAlt } from "react-icons/fa";
                      ...
                      <li
                        className={clsx(
                          "z-50 flex cursor-pointer items-center relative rounded-full font-bold",
                          {
                            ...
                            "ml-auto gap-1 h-9 justify-center bg-red-600 text-white font-bold sm:px-6 hover:bg-red-400":
                              !menuOpen,
                          }
                        )}
                        onClick={async () => {
